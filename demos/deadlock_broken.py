...
def process_a(lock_1, lock_2):
    ...
    lock_2.acquire()
    print("A: acquired lock_2 (this will never print)")


def process_b(lock_1, lock_2):
    print("B: acquiring lock_2")
    lock_2.acquire()
    print("B: lock_2 acquired")

    time.sleep(0.05) 

    print("B: trying to acquire lock_1")
    lock_1.acquire()
    print("B: acquired lock_1 (this will never print)")
